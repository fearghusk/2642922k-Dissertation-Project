    ...
    <View style={styles.outer}>
      <View style={styles.header}>
        ...
        {basicInfoLines?.length ? (
          <View style={styles.metaBox} accessible={true} accessibilityLabel="Score information">
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        ...
        {groups.map((g) => {
          ...
          return (
            <View key={g.key} style={styles.groupCard} accessible={true}>
              <Pressable
              ...
              {open ? (
                <View style={styles.groupBody} accessible={true} accessibilityLabel={`Text for ${label}`}>
